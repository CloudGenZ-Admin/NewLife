            ...
            <main className="policy-content">
                <div className="container">
                    <div className="policy-text-wrapper">
                        <h3>OVERVIEW</h3>
                        <p>This website is operated by newlifeproject. Throughout the site, the terms “we”, “us” and “our” refer to newlifeproject. newlifeproject offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
                        ...
                        <p>Questions about the Terms of Service should be sent to us at info@newlifeproject.org.</p>
                    </div>
                </div>
            </main>
        </div>
